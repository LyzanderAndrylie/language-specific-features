...
run_intervention() {
       ...
       python "$DIR/../../scripts/ppl.py" google/gemma-2-9b openlanguagedata/flores_plus \
              --split devtest \
              ...
              --lape-result-path sae_features_specific/google/gemma-2-9b/gemma-scope-9b-pt-mlp-canonical/lape_all.pt \
              --out-path sae_intervention/all/max/mult_${multiplier_value}/ppl_${lang}.pt \
