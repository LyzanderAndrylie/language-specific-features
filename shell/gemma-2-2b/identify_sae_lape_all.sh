...
python "$DIR/../../scripts/identify.py" \
    ...
    --in-path 'sae_features_count/google/gemma-2-2b/gemma-scope-2b-pt-mlp-canonical' \
    --out-path 'sae_features_specific/google/gemma-2-2b/gemma-scope-2b-pt-mlp-canonical' \
