...
python "$DIR/../../scripts/activations_to_sae_features.py" google/gemma-2-2b facebook/xnli \
    --split train \
...
python "$DIR/../../scripts/activations_to_sae_features.py" google/gemma-2-2b google-research-datasets/paws-x \
    --split train \
...
python "$DIR/../../scripts/activations_to_sae_features.py" google/gemma-2-2b openlanguagedata/flores_plus \
    --split dev \
